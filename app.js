...
app.get("/bookingServices", (req,res) => {
    res.render("bookingServices")
})
...
app.get("/onlineStaff", (req,res) => {
    res.render("onlineStaff")
})
...
app.get("/logout", (req, res, next) => {
    req.logout(async (e) => {
        ...
        const employee = await Employee.findById(res.locals.currentUser._id)
        if(employee){
